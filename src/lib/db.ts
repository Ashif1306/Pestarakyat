...
export async function initDatabase() {
  ...
  // Auto-seed event if empty
  const eventCount = await sql`SELECT COUNT(*) as c FROM event`;
  ...
  // Auto-seed sports if empty
  const sportsCount = await sql`SELECT COUNT(*) as c FROM sports`;
  if (Number(sportsCount[0].c) === 0) {
  ...
  const teamsCount = await sql`SELECT COUNT(*) as c FROM teams`;
  if (Number(teamsCount[0].c) === 0) {
    const teamsData = [
      // Volly Putra
      ...
      { id: 'vp-t7', name: 'PBV Bunga Duri', sport_id: 'volly-putra', group_name: 'C' },
      { id: 'vp-t8', name: 'PBV Lamba', sport_id: 'volly-putra', group_name: 'C' },
      { id: 'vp-t9', name: 'PBV Bala Batu B', sport_id: 'volly-putra', group_name: 'C' },
      { id: 'vp-t10', name: 'MVC Malannying', sport_id: 'volly-putra', group_name: 'D' },
      { id: 'vp-t11', name: 'Solleakka Group', sport_id: 'volly-putra', group_name: 'D' },
      { id: 'vp-t12', name: 'PBV Bala Batu A', sport_id: 'volly-putra', group_name: 'D' },
      // Volly Putri
    ...
    for (const t of teamsData) {
      await sql`INSERT INTO teams (id, name, sport_id, group_name) VALUES (${t.id}, ${t.name}, ${t.sport_id}, ${t.group_name}) ON CONFLICT (id) DO NOTHING`;
    }
  }

  // Auto-seed matches if empty
  const matchesCount = await sql`SELECT COUNT(*) as c FROM matches`;
  if (Number(matchesCount[0].c) === 0) {
    const matchesData = [
      ...
      { id: 'sbm-sf1', sport: 'sepak-bola-mini', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Juara Grup A', team_b: 'Runner-up Grup B', date: '2026-08-22', time: '15:30', venue: 'Lapangan Mini Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'sbm-sf2', sport: 'sepak-bola-mini', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Juara Grup B', team_b: 'Runner-up Grup A', date: '2026-08-22', time: '16:15', venue: 'Lapangan Mini Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'sbm-f', sport: 'sepak-bola-mini', phase: 'knockout', group_name: null, round: 'Final', team_a: 'Pemenang SF 1', team_b: 'Pemenang SF 2', date: '2026-08-24', time: '16:00', venue: 'Lapangan Mini Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      // Volly Putra
      ...
      { id: 'vp-3', sport: 'volly-putra', phase: 'group', group_name: 'C', round: 'Fase Grup C', team_a: 'PBV Bunga Duri', team_b: 'PBV Lamba', date: '2026-08-11', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'finished', score_a: 2, score_b: 0, winner: 'PBV Bunga Duri' },
      { id: 'vp-4', sport: 'volly-putra', phase: 'group', group_name: 'D', round: 'Fase Grup D', team_a: 'MVC Malannying', team_b: 'Solleakka Group', date: '2026-08-11', time: '17:00', venue: 'Lapangan Utama Bala Batu', status: 'finished', score_a: 2, score_b: 1, winner: 'MVC Malannying' },
      ...
      { id: 'vp-6', sport: 'volly-putra', phase: 'group', group_name: 'D', round: 'Fase Grup D', team_a: 'Solleakka Group', team_b: 'PBV Bala Batu A', date: '2026-08-12', time: '17:00', venue: 'Lapangan Utama Bala Batu', status: 'finished', score_a: 1, score_b: 2, winner: 'PBV Bala Batu A' },
      { id: 'vp-7', sport: 'volly-putra', phase: 'group', group_name: 'C', round: 'Fase Grup C', team_a: 'PBV Lamba', team_b: 'PBV Bala Batu B', date: '2026-08-13', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'finished', score_a: 0, score_b: 2, winner: 'PBV Bala Batu B' },
      ...
      { id: 'vp-11', sport: 'volly-putra', phase: 'group', group_name: 'C', round: 'Fase Grup C', team_a: 'PBV Bunga Duri', team_b: 'PBV Bala Batu B', date: '2026-08-15', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-12', sport: 'volly-putra', phase: 'group', group_name: 'D', round: 'Fase Grup D', team_a: 'MVC Malannying', team_b: 'PBV Bala Batu A', date: '2026-08-15', time: '17:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-qf1', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup A', team_b: 'Runner-up Grup B', date: '2026-08-20', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-qf2', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup C', team_b: 'Runner-up Grup D', date: '2026-08-20', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-qf3', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup B', team_b: 'Runner-up Grup C', date: '2026-08-21', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-qf4', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup D', team_b: 'Runner-up Grup A', date: '2026-08-21', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-sf1', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Pemenang QF 1', team_b: 'Pemenang QF 2', date: '2026-08-23', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-sf2', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Pemenang QF 3', team_b: 'Pemenang QF 4', date: '2026-08-23', time: '16:30', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vp-f', sport: 'volly-putra', phase: 'knockout', group_name: null, round: 'Final', team_a: 'Pemenang SF 1', team_b: 'Pemenang SF 2', date: '2026-08-25', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      // Volly Putri
      ...
      { id: 'vpi-qf1', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup A', team_b: 'Runner-up Grup B', date: '2026-08-20', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-qf2', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup C', team_b: 'Runner-up Grup D', date: '2026-08-20', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-qf3', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup B', team_b: 'Runner-up Grup C', date: '2026-08-21', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-qf4', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Perempat Final', team_a: 'Juara Grup D', team_b: 'Runner-up Grup A', date: '2026-08-21', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-sf1', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Pemenang QF 1', team_b: 'Pemenang QF 2', date: '2026-08-23', time: '15:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-sf2', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Semi Final', team_a: 'Pemenang QF 3', team_b: 'Pemenang QF 4', date: '2026-08-23', time: '16:30', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
      { id: 'vpi-f', sport: 'volly-putri', phase: 'knockout', group_name: null, round: 'Final', team_a: 'Pemenang SF 1', team_b: 'Pemenang SF 2', date: '2026-08-25', time: '16:00', venue: 'Lapangan Utama Bala Batu', status: 'scheduled', score_a: null, score_b: null, winner: null },
    ];
